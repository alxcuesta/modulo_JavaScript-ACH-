...
console.log ('hola antepenultimo ejercicio')
...
inputName.addEventListener('focus', cambiaColorFoco);
function cambiaColorFoco() {
  inputName.style.backgroundColor = '#fff666';
};
inputName.addEventListener('focusout', cambiaColorNoFoco);
...
letraRandom.addEventListener('keypress', checkLetter);
